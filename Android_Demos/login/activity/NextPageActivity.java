...
public class NextPageActivity extends AppCompatActivity {
    ...
    public void init(){
        ...
        //Map infoMap = saveInfoUtils.getUserInfoFromFile();
        Map infoMap = saveInfoUtils.getUserInfoFromPref();

        usernameTextView = (TextView) findViewById(R.id.username_show);
        passwordTextView = (TextView) findViewById(R.id.password_show);

        usernameTextView.setText((String) infoMap.get("username"));
        passwordTextView.setText((String) infoMap.get("password"));
    }
}
